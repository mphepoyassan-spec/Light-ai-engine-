...
public class TokenSaver
{
    ...
    private static readonly Regex FillerWordsRegex = new Regex(@"\s*\b(uh|um|er|ah|like|you know|basically|actually)\b\s*", RegexOptions.IgnoreCase | RegexOptions.Compiled);
